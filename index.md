...
Ven a visitarnos. [Queda con nosotros](https://docs.google.com/forms/d/e/1FAIpQLScOgBeQpwtdsDgNUp7CHEr-YBsJX2y7Aga453hMLL6sPR157g/viewform) para visitar los laboratorios de nuestra escuela en el campus de Fuenlabrada de la URJC: los profesores te explicarán qué se hace en cada laboratorio, podrás acceder como oyente a clases en directo. No te lo pierdas.
...
### 23 laboratorios: cada semana cientos de alumnos tienen clase de
...
2. Laboratorio de Robótica y Sistemas Ubicuos
     (hardware). L3104. Laboratorio dotado con distintos tipos de
...
6. Laboratorio de Ingeniería Biomédica (software y
     hardware). L3204. Dotado de 20 puestos que combinan programas de
...
8. Laboratorio de Terminales de Comunicación (software y
     hardware). L3206 Este laboratorio consta de 20 puestos de trabajo
     ...
     telecomunicación.
9. Laboratorio de Sistemas Operativos y Middleware
     (software). L3207. Laboratorio con 50 máquinas (más un puesto de
...
11. Laboratorio de Sistemas Distribuidos y Cloud Computing
     (software). L3209. Laboratorio con 56 máquinas (más un puesto de
     profesor) configuradas como estaciones de trabajo de tipo Unix
     ...
     Computing.
12. Laboratorio de Virtualización de Redes
     (software). L3210. Laboratorio con 70 máquinas (más un puesto de
     profesor) configuradas como estaciones de trabajo de tipo Unix
...
17. Laboratorio de Procesamiento Digital (software y
     hardware). L2009. Este laboratorio consta de 40 puestos de
...
20. Laboratorio de Análisis y Diseño de Circuitos
     (hardware). L2103. Este laboratorio consta de 40 puestos de
